...
function setupUI() {
    ...
    githubDiv.style.marginTop = 'auto';
    githubDiv.style.padding = '12px 18px';
    githubDiv.style.borderTop = '1px solid #3e3d32';
    ...
    githubLink.addEventListener('mouseenter', () => {
        githubLink.style.color = '#f92672';
    });
    githubLink.addEventListener('mouseleave', () => {
        githubLink.style.color = '#a6e22e';
    });
    
    sidebar.appendChild(githubDiv);
